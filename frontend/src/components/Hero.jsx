...
const Hero = () => {
  return (
    <section className="relative my-8 overflow-hidden rounded-[2rem] bg-[#0b0b0d] px-6 py-10 text-white shadow-[0_30px_80px_rgba(20,20,25,0.18)] sm:px-10 sm:py-16 lg:px-16 lg:py-20">
      ...
      <div className="relative grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="max-w-2xl">
          <p className="inline-flex rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-white/75">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                to="/iphone"
                className="rounded-full bg-white px-5 py-3 text-sm font-semibold text-[#1d1d1f] transition hover:scale-[1.02] hover:bg-white/90"
              >
                Explore iPhone
              </Link>
              <Link
        ...
        <div className="relative mx-auto h-[360px] w-full max-w-xl sm:h-[420px]">
          <div className="absolute left-[3%] top-12 w-[45%] rotate-[-8deg] overflow-hidden rounded-[2rem] border border-white/15 bg-[#17171b] p-2 shadow-[0_24px_48px_rgba(0,0,0,0.38)]">
              <img
                className="h-[265px] w-full rounded-[1.5rem] object-cover sm:h-[315px]"
                src={iphoneVisual}
                alt="iPhone hero visual"
              />
          </div>
          <div className="absolute bottom-0 right-[3%] w-[56%] rotate-[6deg] overflow-hidden rounded-[2rem] border border-white/20 bg-[#17171b] p-2 shadow-[0_30px_55px_rgba(0,0,0,0.5)]">
              <img
                className="h-[305px] w-full rounded-[1.5rem] object-cover sm:h-[355px]"
                src={androidVisual}
