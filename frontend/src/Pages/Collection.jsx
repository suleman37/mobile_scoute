...
const Collection = ({
  ...
  return (
    <div className="flex flex-col gap-6 py-10 lg:flex-row lg:gap-10">
      <aside className="min-w-60 rounded-[10px] border border-black/[0.07] bg-white p-5 lg:h-fit">
        <p
      ...
      <div className="flex-1">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          {sortedProducts.length > 0 && (
            <select
              className="rounded-[10px] border border-black/[0.08] bg-white px-4 py-2.5 text-sm text-[#424245] outline-none"
